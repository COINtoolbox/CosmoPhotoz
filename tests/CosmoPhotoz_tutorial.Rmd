...
authors: "Rafael S. de Souza, Jonny Elliot, Alberto Krone-Martins, Émille Ishida, 
Joseph Hilbe"
---
...
```{r,fig.width=8, fig.height=9}
plotDiagPhotoZ(photoz, specz, type = "predobs")+coord_cartesian(xlim =c(0,1.5), ylim = c(0,1.5))
```


Scatter distribution as a function of redshift 
